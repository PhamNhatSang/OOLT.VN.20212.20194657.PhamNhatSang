  ...
  // collection.add(listcd[2]);
   ...
   java.util.Iterator iterator = collection.iterator();
      ...
      while(iterator.hasNext()) {
       ...
       boolean fake=collection.remove(listdvd[0]);
       iterator=collection.iterator();
        System.out.println("-----------------------");
        System.out.println("The Medias after remove ");
        while(iterator.hasNext()) {
        	System.out.println(((DigitalVideoDisc)iterator.next()).getTitle());
        }
	}
	public void AssertMedia(Media media) {
		assert media.getCategory() != null  &&media.getTitle()!=null: "Error because DVD has null";
		 
		assert media.getCategory() != ""  && media.getTitle() !="" :"Error because have empty ";
	}
}
