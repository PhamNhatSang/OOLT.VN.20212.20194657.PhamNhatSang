	...
	private Order orderTMP=new Order();
	  int i=0;
	   public void start(Stage primaryStage) {
	      ...
	      LuckyItem=new Button("Get Lucky Item");
	      ...
	      LuckyItem.setOnAction(evt->RuleOfLucky(primaryStage));
	      ...
	      flow.getChildren().addAll(CreateOrder, Additem, RemoveItem,Display,LuckyItem);
...
public void RuleOfLucky(Stage primary) {
	
	TextField Valuecost=new TextField();
	Valuecost.setPrefWidth(120);
	TextField Valueitem=new TextField();
	Valueitem.setPrefWidth(120);
	Valuecost.setPromptText("Insert value cost");
	Valueitem.setPromptText("Value item");
	FlowPane flow = new FlowPane();
	Button RollitemLuckky =new Button("Roll Item Lucky");
	
	RollitemLuckky.setOnAction(evt->{
		try {
		float Precost=Float.parseFloat(Valuecost.getText());
		int item=Integer.parseInt(Valueitem.getText());
		GetItemluck(Precost,item);
		}catch(NullPointerException e) {
			Alert alert = new Alert(AlertType.ERROR);
			alert.setTitle("ERROR");
			alert.setHeaderText(null);
			alert.setContentText("Your string is null");
			alert.showAndWait();
		}catch(NumberFormatException e) {
			Alert alert = new Alert(AlertType.ERROR);
			alert.setTitle("ERROR");
			alert.setHeaderText(null);
			alert.setContentText("Your Number you insert is not right");
			alert.showAndWait();
		}
    ...
    Button Back=new Button("Back");
    Back.setOnAction(evt->start(primary));
    flow.getChildren().addAll( Valuecost,Valueitem,RollitemLuckky,Back);
   
   
    primary.setScene(new Scene(flow, 300, 120));
    primary.setTitle("Item lucky");
    primary.show();
}
public void GetItemluck(float Precost,int numberItem) {
	if(i!=0) {
		if(order[i-1].totalCost()>=Precost&&order[i-1].getItemsOrdered().size()>=numberItem) {
	 CompactDisc [] listcd= new CompactDisc[5];
     ArrayList<Track> track1 = new ArrayList<Track>();
     ArrayList<Track> track2 = new ArrayList<Track>();
     ArrayList<Track> track3 = new ArrayList<Track>();
     ArrayList<Track> track4 = new ArrayList<Track>();
     ArrayList<Track> track5 = new ArrayList<Track>();
    track1.add(new Track("New Devide",6));
    track1.add(new Track("Numb",7));
    track1.add(new Track("Dark",8));
    track1.add(new Track("Overpass Graffiti",5));
    track2.add(new Track("Blank Space",7));
    track2.add(new Track("Bad Blood",4));
    track2.add(new Track("Love Story",5));
    ...
    track5.add(new Track("One Call Away",8));
    track5.add(new Track("Cheating on you",9));
    listcd[0] =new CompactDisc("The Songs of Ed LinkinPark","Music",88.65f,26,"AsB Media","Ed Sheran",track1);
    
    listcd[1] =new CompactDisc("The Songs of EdWoord","Music",99.76f,24,"ADC Entertainment","Taylor Swift",track2);
    listcd[2] =new CompactDisc("The Songs of KindoomStack","Music",135.65f,26,"Maroon Entertainment","Maroon 5",track3);
    listcd[3] =new CompactDisc("The Songs of Imagginedragon","Music EDM",166.75f,26,"AVC Media","Avicii",track4);
    listcd[4] =new CompactDisc("The Songs of DarkHole","Music",100f,27,"Free Studio","Charlie Puth",track5);
   ...
   Book [] listbook =new Book[5]; 
   listbook[0]= new Book("Amanda and the god","Adventure book",16.50f,author2);
   listbook[1]= new Book("The Algorithms","Adventure book",24.63f,author4);
   listbook[2]= new Book("IT in the world ","Mafia book",35.53f,author3);
   listbook[3]= new Book("The war will be end","Emotion book",22.33f,author1);
   listbook[4]= new Book("Don Quixote","History book",15.89f,author5);
	DigitalVideoDisc [] listdvd =new DigitalVideoDisc[12];
    listdvd[0]=new DigitalVideoDisc( "The adventure of De Men","BookDVD",33.65f,120,"Dale Carnegie");
    listdvd[1]=new DigitalVideoDisc( "Into the universe","BookDVD",88.55f,140,"Mitch Albom");
    listdvd[2]=new DigitalVideoDisc( "Titanic","BookDVD",64.65f,156,"Harper Lee");
    listdvd[3]=new DigitalVideoDisc( "Can i hear you voice","BookDVD",125.4f,122,"Luis Sepúlveda");
    listdvd[4]=new DigitalVideoDisc( "The dom of the kingdom ","BookDVD",99.43f,170,"Lewis Carrol");
    listdvd[5]=new DigitalVideoDisc( "Brave","BookDVD",40.65f,127,"Saint-Exupéry");
    listdvd[6]=new DigitalVideoDisc( "The repunzle","BookDVD",44.65f,222,"J.D.Salinger");
    listdvd[7]=new DigitalVideoDisc( "Night heart","Anime",98.98f,1200,"Oda");
    listdvd[8]=new DigitalVideoDisc( "Baiking","Anime",96.65f,180,"Sotozaki Haruo");
    listdvd[9]=new DigitalVideoDisc( "Legend of Egypt","Action Movie",48.65f,166,"Kevin Kleird");
    listdvd[10]=new DigitalVideoDisc( "DarkNight in godtham","Action Movie",80.65f,126,"Sam Raimi");
    listdvd[11]=new DigitalVideoDisc( "God father","BookDVD",30.65f,121,"Victor Fleming");
    ArrayList<Media> collection = new java.util.ArrayList();
	...
	if(float_random>point) {
	String tmp=	order[i-1].getALuckyItem(collection).getTitle();
	Alert alert = new Alert(AlertType.INFORMATION);
	alert.setTitle("NOTICE");
	alert.setHeaderText(null);
	alert.setContentText("You  have  Lucky item: "+tmp);
	alert.showAndWait();
		...
		alert.setTitle("NOTICE");
		alert.setHeaderText(null);
		alert.setContentText("You do not have any Lucky item");
		alert.showAndWait();
	}
		}
	else {
...
public static void main(String[] args)  {
	 launch(args);// RUN THE GUI OF AIMS PROJECT
	 
//**************************************************************************************************************
	//TEST  PLAYEREXEPTION
	DigitalVideoDisc listdvd=new DigitalVideoDisc( "Dac Nhan Tam","BookDVD",33.65f,-1,"Dale Carnegie");
		...
		DigitalVideoDisc listdvd1=null;
		Order order=new Order();
		listdvd.compareTo(listdvd1);
